var main = function () { //главная функция
	...
	$('.icon__close').click(function () { //выбираем класс icon-close и метод click
		...
		$('body').animate({ //выбираем класс burger и метод animate
	...
	$('#ads').click(function () {
		$('#ads_close').css("display", "flex");
	});
	$('.ads_back').click(function () {
		$('#ads_close').css("display", "none");
	});
};
...
// 		var div = $("#ads"); // тут указываем ID элемента
